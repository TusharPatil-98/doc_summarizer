...
class DocumentStorage:
    ...
    def add_components(self) -> None:
        ...
        self.__pipeline.add_component(
            "file_type_router",
            FileTypeRouter(mime_types=DocumentConfig.supported_mime_types),
        )
        ...
        self.__pipeline.add_component(
            "splitter",
            DocumentSplitter(
                split_by=DocumentConfig.split_by,
        ...
        self.__pipeline.add_component(
            "writer", DocumentWriter(document_store=self.__doc_store)
        )

    def connect_components(self) -> None:
        self.__pipeline.connect(
